...
let paletteSize = 16; //will make this option between 16/32
...
function buildCanvas(){
    ...
    pixel.classList.add(getPixelClass(paletteSize))
...
function downloadAsPNG(){
   ...
   canvasElem.toBlob(blob => {
    ...
    download.setAttribute("download", "pixelart" + paletteSize + "x" + paletteSize + ".png");
...
function createCanvasElem(){
    ...
    canvasElem.height = paletteSize
    canvasElem.width = paletteSize
